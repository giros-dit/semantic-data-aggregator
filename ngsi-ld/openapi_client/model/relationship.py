...
class Relationship(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): defaults to "Relationship", must be one of ["Relationship", ]  # noqa: E501
        ...
        type = kwargs.get('type', "Relationship")
