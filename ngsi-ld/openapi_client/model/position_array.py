...
class PositionArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PositionArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([Position]): An array of positions.  # noqa: E501

        Keyword Args:
            value ([Position]): An array of positions.  # noqa: E501
