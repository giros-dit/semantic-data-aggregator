...
def lazy_import():
    ...
    globals()['EntityTemporal'] = EntityTemporal


class EntityTemporalList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """EntityTemporalList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([EntityTemporal]):  # noqa: E501

        Keyword Args:
            value ([EntityTemporal]):  # noqa: E501
