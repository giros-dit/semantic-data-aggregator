...
def lazy_import():
    ...
    globals()['ContextSourceRegistration'] = ContextSourceRegistration


class ContextSourceRegistrationList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ContextSourceRegistrationList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ContextSourceRegistration]):  # noqa: E501

        Keyword Args:
            value ([ContextSourceRegistration]):  # noqa: E501
