...
class GeoProperty(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """GeoProperty - a model defined in OpenAPI

        Args:
            value (Geometry):

        Keyword Args:
            type (str): defaults to "GeoProperty", must be one of ["GeoProperty", ]  # noqa: E501
        ...
        type = kwargs.get('type', "GeoProperty")
