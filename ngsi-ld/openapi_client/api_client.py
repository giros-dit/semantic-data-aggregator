...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BatchOperationsApi()
        api_instance.batch_entity_creation  # this is an instance of the class Endpoint
        api_instance.batch_entity_creation()  # this invokes api_instance.batch_entity_creation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batch_entity_creation.callable or self.callable in this class
