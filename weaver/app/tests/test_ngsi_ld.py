...
class TestOrionLD(unittest.TestCase):
    def setUp(self):
    ...
    def test_check_orion_status(self):
        self.assertTrue(self.ngsi.checkOrionHealth())
    ...
    def test_create_entity(self):
        ...
        response = self.ngsi.retrieveEntityById(entityId="urn:ngsi-ld:Endpoint:1")
