...
# usage: python3 publisher-logparser.py {broker_ip_address}:{port} {topic} {logs_published}
# e.g.   python3 publisher-logparser.py kafka:9092 logparser-topic-1 10

def publish(producer, topic_name):
    with open('log-sample-input.json') as json_file:
