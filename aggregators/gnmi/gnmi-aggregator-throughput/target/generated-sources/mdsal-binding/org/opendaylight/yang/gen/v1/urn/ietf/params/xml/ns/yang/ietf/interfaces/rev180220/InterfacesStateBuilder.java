...
/**
 * Class that builds {@link InterfacesStateBuilder} instances. Overall design of the class is that of a
 ...
 * <pre>
 *   <code>
 *     InterfacesStateBuilder createTarget(int fooXyzzy, int barBaz) {
 *         return new InterfacesStateBuilderBuilder()
 ...
 *
 * <p>
 * This pattern is supported by the immutable nature of InterfacesStateBuilder, as instances can be freely passed around without
...
public class InterfacesStateBuilder implements Builder<InterfacesState> {
    ...
    Map<Class<? extends Augmentation<InterfacesState>>, Augmentation<InterfacesState>> augmentation = Collections.emptyMap();
    ...
    public InterfacesStateBuilder(InterfacesState base) {
        Map<Class<? extends Augmentation<InterfacesState>>, Augmentation<InterfacesState>> aug = base.augmentations();
        if (!aug.isEmpty()) {
    ...
    public InterfacesStateBuilder setInterface(final Map<InterfaceKey, Interface> values) {
    ...
    public InterfacesStateBuilder setInterface(final List<Interface> values) {
    ...
    public InterfacesStateBuilder addAugmentation(Augmentation<InterfacesState> augmentation) {
        Class<? extends Augmentation<InterfacesState>> augmentationType = augmentation.implementedInterface();
    ...
    @Deprecated
    private static final class InterfacesStateImpl
        extends AbstractAugmentable<InterfacesState>
        implements InterfacesState {
    
        private final Map<InterfaceKey, Interface> _interface;
    
        InterfacesStateImpl(InterfacesStateBuilder base) {
        ...
        public int hashCode() {
            ...
            final int result = InterfacesState.bindingHashCode(this);
            hash = result;
            hashValid = true;
            return result;
        }
