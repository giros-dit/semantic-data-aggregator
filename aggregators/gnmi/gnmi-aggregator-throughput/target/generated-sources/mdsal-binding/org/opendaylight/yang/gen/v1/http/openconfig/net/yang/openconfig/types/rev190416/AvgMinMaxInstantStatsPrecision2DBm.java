...
/**
 * Common grouping for recording dBm values with 2 decimal precision. Values 
 * include the instantaneous, average, minimum, and maximum statistics. Statistics 
 * are computed and reported based on a moving time interval (e.g., the last 30s). 
 * If supported by the device, the time interval over which the statistics are 
 ...
 * <i>openconfig-types/avg-min-max-instant-stats-precision2-dBm</i>
 *
 */
@Generated("mdsal-binding-generator")
public interface AvgMinMaxInstantStatsPrecision2DBm
    extends
    DataObject,
    StatIntervalState,
    MinMaxTime
{
    ...
    public static final @NonNull QName QNAME = $YangModuleInfoImpl.qnameOf("avg-min-max-instant-stats-precision2-dBm");
