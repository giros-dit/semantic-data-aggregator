...
public class ConfigBuilder implements Builder<Config> {
    ...
    public ConfigBuilder(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfacePhysHoldtimeConfig arg) {
        this._up = arg.getUp();
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfacePhysHoldtimeConfig]");
    }
    ...
    public ConfigBuilder setDown(final Uint32 value) {
        this._down = value;
        return this;
    }
    ...
    public ConfigBuilder setDown(final Long value) {
        return setDown(CodeHelpers.compatUint(value));
    }
    
    public ConfigBuilder setUp(final Uint32 value) {
        this._up = value;
        return this;
    }
     ...
     */
    @Deprecated(forRemoval = true)
    public ConfigBuilder setUp(final Long value) {
