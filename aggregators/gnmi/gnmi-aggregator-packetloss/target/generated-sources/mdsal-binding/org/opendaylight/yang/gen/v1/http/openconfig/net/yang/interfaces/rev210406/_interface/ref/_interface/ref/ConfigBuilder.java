...
public class ConfigBuilder implements Builder<Config> {
    ...
    public ConfigBuilder(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfaceRefCommon arg) {
        this._interface = arg.getInterface();
        this._subinterface = arg.getSubinterface();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfaceRefCommon</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfaceRefCommon) {
            this._interface = ((org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfaceRefCommon)arg).getInterface();
            this._subinterface = ((org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfaceRefCommon)arg).getSubinterface();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev210406.InterfaceRefCommon]");
    }
    ...
    public ConfigBuilder setInterface(final String value) {
        this._interface = value;
        return this;
    }
    
    public ConfigBuilder setSubinterface(final Object value) {
        this._subinterface = value;
        return this;
    }
    ...
    private static final class ConfigImpl
        ...
        private final Object _subinterface;
