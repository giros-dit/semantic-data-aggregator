...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final @NonNull QName NAME = QName.create("http://data-aggregator.com/ns/netflow-aggregated", "2022-03-02", "netflow-v9-agg").intern();
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.netflow.rev211008.$YangModuleInfoImpl.getInstance());
    ...
    protected String resourceName() {
        return "/META-INF/yang/netflow-v9-agg@2022-03-02.yang";
    }
