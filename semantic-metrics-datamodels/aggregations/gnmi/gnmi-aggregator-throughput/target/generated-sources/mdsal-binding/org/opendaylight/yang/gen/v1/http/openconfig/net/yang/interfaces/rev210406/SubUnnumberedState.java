 ...
 * <i>openconfig-interfaces/sub-unnumbered-state</i>
 *
 */
@Generated("mdsal-binding-generator")
public interface SubUnnumberedState
    extends
    DataObject
{
    ...
    public static final @NonNull QName QNAME = $YangModuleInfoImpl.qnameOf("sub-unnumbered-state");

    @Override
    Class<? extends SubUnnumberedState> implementedInterface();
