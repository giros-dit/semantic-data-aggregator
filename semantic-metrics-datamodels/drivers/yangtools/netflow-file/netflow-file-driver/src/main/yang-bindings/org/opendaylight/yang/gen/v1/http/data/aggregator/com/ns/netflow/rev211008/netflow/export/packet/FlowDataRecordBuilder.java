...
public class FlowDataRecordBuilder implements Builder<FlowDataRecord> {
    ...
    private Timestamp _firstSwitched;
    ...
    private Ipv4 _ipv4;
    private Ipv6 _ipv6;
    private Timestamp _lastSwitched;
    ...
    */
    ...
    public Timestamp getFirstSwitched() {
    ...
    public Timestamp getLastSwitched() {
    ...
    public FlowDataRecordBuilder setFirstSwitched(final Timestamp value) {
    ...
    public FlowDataRecordBuilder setLastSwitched(final Timestamp value) {
    ...
    private static final class FlowDataRecordImpl
        ...
        private final Timestamp _firstSwitched;
        ...
        private final Timestamp _lastSwitched;
