...
public class EveDriverTest {
    ...
    @Before
    public void init() {
        testRunner = TestRunners.newTestRunner(EveDriver.class);
    ...
    public void testProcessor() {
        ...
        List<MockFlowFile> results = testRunner.getFlowFilesForRelationship(EveDriver.SUCCESS);
