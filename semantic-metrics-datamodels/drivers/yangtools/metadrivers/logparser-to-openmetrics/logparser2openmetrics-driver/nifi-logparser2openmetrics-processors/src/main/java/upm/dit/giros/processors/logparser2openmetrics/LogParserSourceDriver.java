...
/**
 * LogParser YANGTools Source Driver.
 */
public class LogParserSourceDriver {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LogParserSourceDriver.class);
    ...
    public String driver(JsonObject metrics_data) {   
