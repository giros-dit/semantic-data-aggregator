...
/**
 * LogParser to OpenMetrics YANGTools Transformer Driver Tester.
 */
public class LogParserToOpenmetricsTransformerDriverTester extends Thread {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LogParserToOpenmetricsTransformerDriverTester.class);
    ...
    public LogParserToOpenmetricsTransformerDriverTester(String metric_family_name, String metric_family_type, String metric_family_unit, String metric_family_help){
    ...
    public void run() {
        int i = 0;
        while (i < 100){
            File driver_input = new File(LogParserToOpenmetricsMetaDriverTester.class.getClassLoader().getResource("transformer-instantiation-input.json").getFile());
            ...
            try{
                ...
                System.out.println("LogParserToOpenmetrics transformer driver output: " + driver_output.toString());
                System.out.println("");
