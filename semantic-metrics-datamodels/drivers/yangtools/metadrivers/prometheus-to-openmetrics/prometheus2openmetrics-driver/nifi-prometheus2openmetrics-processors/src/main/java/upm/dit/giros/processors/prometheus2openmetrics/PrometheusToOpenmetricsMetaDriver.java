 ...
 */
package upm.dit.giros.processors.prometheus2openmetrics;
...
/**
 * Prometheus to Openmetrics YANGTools Meta Driver.
 */
@Tags({"Prometheus to Openmetrics YANGTools Meta Driver"})
@CapabilityDescription("NiFi processor to implement the Prometheus to Openmetrics YANGTools Meta Driver.")
@SeeAlso({})
