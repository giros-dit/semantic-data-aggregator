...
public class MetricBuilder implements Builder<Metric> {
    ...
    private Class<? extends MetricIdentity> _name;
    private Long _value;
    ...
    public Class<? extends MetricIdentity> getName() {
        return _name;
    }
    ...
    public MetricBuilder setName(final Class<? extends MetricIdentity> value) {
        this._name = value;
        return this;
    }
    
    public MetricBuilder setValue(final Long value) {
        this._value = value;
        return this;
    }
    ...
    private static final class MetricImpl
        ...
        MetricImpl(MetricBuilder base) {
            ...
            if (base.key() != null) {
                ...
                this.key = new MetricKey(base.getName());
            }
