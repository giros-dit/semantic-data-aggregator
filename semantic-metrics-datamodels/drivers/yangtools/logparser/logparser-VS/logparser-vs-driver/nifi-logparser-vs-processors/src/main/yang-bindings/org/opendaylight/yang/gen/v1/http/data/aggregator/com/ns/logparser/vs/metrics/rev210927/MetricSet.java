...
/**
 * Metric set associated with a LogParser Vertical Slicer (VS) operation log.
 *
 * <p>
    ...
    DataObject
{
     ...
     * </pre>
     *
     * @return {@code org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.logparser.vs.metrics.rev210927.metric.set.Metrics} metrics, or {@code null} if it is not present.
     *
     */
    Metrics getMetrics();
