...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final @NonNull QName NAME = QName.create("urn:ietf:params:xml:ns:netconf:base:1.0", "2011-06-01", "ietf-netconf").intern();
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.inet.types.rev210222.$YangModuleInfoImpl.getInstance());
    ...
    protected String resourceName() {
        return "/META-INF/yang/ietf-netconf@2011-06-01.yang";
    }
