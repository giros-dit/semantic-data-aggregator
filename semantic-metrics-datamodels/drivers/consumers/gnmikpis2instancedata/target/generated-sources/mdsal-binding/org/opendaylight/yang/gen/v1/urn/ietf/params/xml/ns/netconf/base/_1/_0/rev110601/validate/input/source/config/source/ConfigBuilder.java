...
public class ConfigBuilder implements Builder<Config> {
    ...
    private org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.netconf.base._1._0.rev110601.validate.input.source.config.source.config.Config _config;
    ...
    public org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.netconf.base._1._0.rev110601.validate.input.source.config.source.config.Config getConfig() {
        return _config;
    }
    ...
    public ConfigBuilder setConfig(final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.netconf.base._1._0.rev110601.validate.input.source.config.source.config.Config value) {
        this._config = value;
        return this;
    }
    ...
    private static final class ConfigImpl
        ...
        private final org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.netconf.base._1._0.rev110601.validate.input.source.config.source.config.Config _config;
