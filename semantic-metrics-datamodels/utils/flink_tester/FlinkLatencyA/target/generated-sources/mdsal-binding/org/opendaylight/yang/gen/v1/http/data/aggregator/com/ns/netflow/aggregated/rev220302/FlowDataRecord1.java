    ...
    Augmentation<FlowDataRecord>
{
    ...
    static int bindingHashCode(final org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.netflow.aggregated.rev220302.@NonNull FlowDataRecord1 obj) {
        ...
        result = prime * result + Objects.hashCode(obj.getRatioBytesInPerOut());
        result = prime * result + Objects.hashCode(obj.getRatioPktsInPerOut());
        return result;
    }
    ...
    static boolean bindingEquals(final org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.netflow.aggregated.rev220302.@NonNull FlowDataRecord1 thisObj, final Object obj) {
        ...
        if (!Objects.equals(thisObj.getRatioBytesInPerOut(), other.getRatioBytesInPerOut())) {
            return false;
        }
        if (!Objects.equals(thisObj.getRatioPktsInPerOut(), other.getRatioPktsInPerOut())) {
            return false;
        }
        return true;
    }
    ...
    static String bindingToString(final org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.netflow.aggregated.rev220302.@NonNull FlowDataRecord1 obj) {
        ...
        CodeHelpers.appendValue(helper, "ratioBytesInPerOut", obj.getRatioBytesInPerOut());
        CodeHelpers.appendValue(helper, "ratioPktsInPerOut", obj.getRatioPktsInPerOut());
    ...
    /**
     * Return ratioBytesInPerOut, or {@code null} if it is not present.
     * 
     * <pre>
     *     <code>
     ...
     * </pre>
     * 
     * @return {@code org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.netflow.aggregated.rev220302.PerDecimal} ratioBytesInPerOut, or {@code null} if it is not present.
     *
     */
    PerDecimal getRatioBytesInPerOut();
    
    /**
     * Return ratioPktsInPerOut, or {@code null} if it is not present.
     * 
     * <pre>
     *     <code>
     ...
     * </pre>
     * 
     * @return {@code org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.netflow.aggregated.rev220302.PerDecimal} ratioPktsInPerOut, or {@code null} if it is not present.
     *
     */
    PerDecimal getRatioPktsInPerOut();
