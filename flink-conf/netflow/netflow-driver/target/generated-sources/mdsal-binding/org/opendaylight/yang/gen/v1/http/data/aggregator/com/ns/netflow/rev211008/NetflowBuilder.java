...
public class NetflowBuilder implements Builder<Netflow> {
    ...
    private List<FieldsFlowRecord> _fieldsFlowRecord;
    ...
    public NetflowBuilder(Netflow base) {
        ...
        this._fieldsFlowRecord = base.getFieldsFlowRecord();
    }


    public List<FieldsFlowRecord> getFieldsFlowRecord() {
        return _fieldsFlowRecord;
    }
    ...
    public NetflowBuilder setFieldsFlowRecord(final List<FieldsFlowRecord> values) {
        this._fieldsFlowRecord = values;
        return this;
    }
    ...
    private static final class NetflowImpl
        ...
        private final List<FieldsFlowRecord> _fieldsFlowRecord;
    
        NetflowImpl(NetflowBuilder base) {
            super(base.augmentation);
            this._fieldsFlowRecord = CodeHelpers.emptyToNull(base.getFieldsFlowRecord());
        }
